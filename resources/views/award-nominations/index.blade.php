                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="clinic_id" id="clinic">
                                <option value="select">Select Clinic</option>
                                @foreach ($clinics as $clinic)
                                    <option
                                    value="{{ $clinic->id }}">{{ strip_tags($clinic->name) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label for="nominee">Select Nominee</label>
                            <select class="form-control select2"
                                name="nominee"
                                id="nominee"
                                data-placeholder="Select Nominee">
                            </select>
                        </div>
                    </div>

                    <div class="col d-inline-block award-nomination-filter">
                        <div class="form-group">
