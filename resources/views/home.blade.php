                ...
                <div class="row pr-lg-5 h-100 align-items-center">
                  <div class="col-md-5 mb-4">
                    ...
                    <div>
                        ...
                        <br>
                        <a href="{{ asset('media/downloads/VP_Awards_Clinics_Infograph.jpg')}}" download class="btn btn-hero btn-hero-primary btn-hero-lg waves-effect waves-light mb-3">CLINIC AWARDS INFORMATION</a>
                        <a href="{{ asset('media/downloads/VP_Awards_Support_Office_Infograph.jpg')}}" download class="btn btn-hero btn-hero-light btn-hero-lg waves-effect waves-light">SUPPORT OFFICE AWARDS INFORMATION</a>
                    </div>
